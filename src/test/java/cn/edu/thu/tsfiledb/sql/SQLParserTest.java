...
public class SQLParserTest {
    ...
    public void multiInsert3() throws ParseException {
        // template for test case
        ArrayList<String> ans = new ArrayList<>(Arrays.asList("TOK_INSERT", "TOK_PATH", "root", "vehicle", "d0",
                "TOK_MULT_IDENTIFIER", "TOK_TIME", "s0","s1" ,"TOK_MULT_VALUE","TOK_DATETIME" ,"2017-6-2T12:00:12.000", "-1011.666", "1231"));
        ArrayList<String> rec = new ArrayList<>();
        ASTNode astTree = ParseGenerator.generateAST("insert into root.vehicle.d0 (timestamp, s0, s1)  values(2017-6-2T12:00:12.000, -1011.666, 1231)");
        astTree = ParseUtils.findRootNonNullToken(astTree);
        recursivePrintSon(astTree, rec);
...
//    }
    ...
    public void selectIndex2() throws ParseException, RecognitionException {
    	ArrayList<String> ans = new ArrayList<>(Arrays.asList("TOK_QUERY", 
    			...
    			"0.123", "0.5"));
        ArrayList<String> rec = new ArrayList<>();
        ASTNode astTree = ParseGenerator.generateAST("select index subsequence_matching(root.a.b.c, root.a.b.c, 123, 132 , 123.1, 0.123, 0.5)");
        astTree = ParseUtils.findRootNonNullToken(astTree);
        recursivePrintSon(astTree, rec);
