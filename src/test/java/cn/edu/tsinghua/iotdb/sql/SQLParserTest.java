...
//    }
    ...
    public void query5() throws ParseException {
        ...
        ArrayList<String> ans = new ArrayList<>(Arrays.asList("TOK_QUERY", "TOK_SELECT",
                ...
                "TOK_FROM", "TOK_PATH", "TOK_ROOT", "vehicle",
                "TOK_WHERE", "or",
                "and","<", "TOK_PATH", "time", "1234567",
                ">", "TOK_PATH", "time", "TOK_DATETIME" ,"2017-6-2T12:00:12+07:00",
                ">","TOK_PATH","device_1","sensor_1","10"));
        ArrayList<String> rec = new ArrayList<>();
        ASTNode astTree = ParseGenerator.generateAST("SELECT * FROM root.vehicle WHERE time < 1234567 and time > 2017-6-2T12:00:12+07:00 or device_1.sensor_1>10");
        astTree = ParseUtils.findRootNonNullToken(astTree);
        recursivePrintSon(astTree, rec);
    ...
    public void query6() throws ParseException {
        ...
        ArrayList<String> ans = new ArrayList<>(Arrays.asList("TOK_QUERY", "TOK_SELECT",
                ...
                "TOK_WHERE", "and",
                "<", "TOK_PATH", "time", "1234567",
                "or",">", "TOK_PATH", "time", "TOK_DATETIME" ,"2017-6-2T12:00:12+07:00",
                ">","TOK_PATH","device_1","sensor_1","10"));
        ArrayList<String> rec = new ArrayList<>();
        ASTNode astTree = ParseGenerator.generateAST("SELECT * FROM root.vehicle WHERE time < 1234567 and (time > 2017-6-2T12:00:12+07:00 or device_1.sensor_1>10)");
        astTree = ParseUtils.findRootNonNullToken(astTree);
    ...
    /*
      Next come seven tests for LIMIT & SLIMIT.
