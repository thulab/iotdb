...
public class MergeTest {
    ...
    private String[] sqls = new String[]{
            "SET STORAGE GROUP TO root.laptop",
            ...
            "insert into root.laptop.d3(timestamp,s2) values(1,1)",
            "flush",
            "merge"
    };
        ...
        try {
            ...
            if (hasResultSet) {
                ...
                while (resultSet.next()) {
                    String ans = resultSet.getString(TIMESTAMP_STR) + "," + resultSet.getString(d3s1) + "," + resultSet.getString(d3s2)
                            +","+resultSet.getString(d2s2);
