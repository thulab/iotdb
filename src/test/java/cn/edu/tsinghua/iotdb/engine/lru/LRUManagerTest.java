...
//	}
//
//	class TestLRUManager extends Manager<TestLRUProcessor> {
//
//		protected TestLRUManager( String normalDataDir) {
//			super(normalDataDir);
//		}
//
//		@Override
...
//
//		manager = new TestLRUManager(dirPath);
