...
public class DeleteIndexOperator implements MetaOperator{
    public static final OperatorType operatorType = OperatorType.DELETE_INDEX;

    public String path;
    public IndexManager.IndexType indexType;

    public DeleteIndexOperator(String path, IndexManager.IndexType indexType) {
        this.path = path;
        this.indexType = indexType;
    }

    public DeleteIndexOperator() {
