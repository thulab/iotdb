...
public class IoTDB implements IoTDBMBean {
    ...
    public void active() {
        ...
        LOGGER.info("{} has started after {}ms.", TsFileDBConstant.GLOBAL_DB_NAME, (System.currentTimeMillis() - startTime));
    }

    private void setUp() throws StartupException {
        setUncaughtExceptionHandler();
        long startTime = System.currentTimeMillis();
        LOGGER.info("Start to recover FileNodeManager ...");
    ...
    private void systemDataRecovery() throws RecoverException {
        LOGGER.info("{}: start checking WALs...", TsFileDBConstant.GLOBAL_DB_NAME);
        ...
        LOGGER.info("Recovery of WAL consumed {}ms", (System.currentTimeMillis() - startTime));
