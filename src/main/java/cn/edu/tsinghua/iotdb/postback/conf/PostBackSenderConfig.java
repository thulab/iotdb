...
public class PostBackSenderConfig {
	...
	public String dataDirectory = new File(TsfileDBDescriptor.getInstance().getConfig().dataDir).getAbsolutePath()
			+ File.separator;
	public String uuidPath;
	public String lastFileInfo;
	public String[] snapshotPaths;
	public String schemaPath = new File(TsfileDBDescriptor.getInstance().getConfig().metadataDir).getAbsolutePath()
