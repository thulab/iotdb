...
//                        break;
//
//                    if (updateOperationReader.verifyTime(pageTimestamps[timeIdx]) && !updateOperationReader.verifyValue()) {
//                        continue;
//                    }
...
//                        if (updateOperationReader.verifyTime(pageTimestamps[timeIdx])) {
//                            res.putInt(updateOperationReader.getInt());
//                        } else {
...
//                        res.putTime(pageTimestamps[timeIdx]);
//                        if (updateOperationReader.verifyTime(pageTimestamps[timeIdx])) {
//                            res.putBoolean(updateOperationReader.getBoolean());
//                        } else {
...
//                        res.putTime(pageTimestamps[timeIdx]);
//                        if (updateOperationReader.verifyTime(pageTimestamps[timeIdx])) {
//                            res.putLong(updateOperationReader.getLong());
//                        } else {
...
//                        res.putTime(pageTimestamps[timeIdx]);
//                        if (updateOperationReader.verifyTime(pageTimestamps[timeIdx])) {
//                            res.putFloat(updateOperationReader.getFloat());
//                        } else {
...
//                        res.putTime(pageTimestamps[timeIdx]);
//                        if (updateOperationReader.verifyTime(pageTimestamps[timeIdx])) {
//                            res.putDouble(updateOperationReader.getDouble());
//                        } else {
...
//                        res.putTime(pageTimestamps[timeIdx]);
//                        if (updateOperationReader.verifyTime(pageTimestamps[timeIdx])) {
//                            res.putBinary(updateOperationReader.getText());
//                        } else {
...
//                            if (updateOperationReader.verifyTime(pageTimestamps[pageTimeIndex])) {
//                                if (updateOperationReader.verifyValue()) {
//                                    aggregateResult.putTime(pageTimestamps[pageTimeIndex]);
//                                    aggregateResult.putInt(updateOperationReader.getInt());
//                                }
//                            } else {
//                                aggregateResult.putTime(pageTimestamps[pageTimeIndex]);
...
//                                if (updateOperationReader.verifyValue()) {
//                                    aggregateResult.putTime(pageTimestamps[pageTimeIndex]);
//                                    aggregateResult.putBoolean(updateOperationReader.getBoolean());
//                                }
//                            } else {
//                                aggregateResult.putTime(pageTimestamps[pageTimeIndex]);
...
//                                if (updateOperationReader.verifyValue()) {
//                                    aggregateResult.putTime(pageTimestamps[pageTimeIndex]);
//                                    aggregateResult.putLong(updateOperationReader.getLong());
//                                }
//                            } else {
//                                aggregateResult.putTime(pageTimestamps[pageTimeIndex]);
...
//                                if (updateOperationReader.verifyValue()) {
//                                    aggregateResult.putTime(pageTimestamps[pageTimeIndex]);
//                                    aggregateResult.putFloat(updateOperationReader.getFloat());
//                                }
//                            } else {
//                                aggregateResult.putTime(pageTimestamps[pageTimeIndex]);
...
//                                if (updateOperationReader.verifyValue()) {
//                                    aggregateResult.putTime(pageTimestamps[pageTimeIndex]);
//                                    aggregateResult.putDouble(updateOperationReader.getDouble());
//                                }
//                            } else {
//                                aggregateResult.putTime(pageTimestamps[pageTimeIndex]);
...
//                                if (updateOperationReader.verifyValue()) {
//                                    aggregateResult.putTime(pageTimestamps[pageTimeIndex]);
//                                    aggregateResult.putBinary(updateOperationReader.getText());
//                                }
//                            } else {
//                                aggregateResult.putTime(pageTimestamps[pageTimeIndex]);
