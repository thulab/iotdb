...
public class QueryRecordReader extends RecordReader{
    ...
    public QueryRecordReader(List<String> filePathList, String deltaObjectId, String measurementId,
                             DynamicOneColumnData lastPageInMemory, List<ByteArrayInputStream> bufferWritePageList,
    ...
    public QueryRecordReader(List<String> filePathList, String unsealedFilePath, List<RowGroupMetaData> rowGroupMetadataList,
    ...
    public DynamicOneColumnData queryOneSeries(SingleSeriesFilterExpression queryTimeFilter, SingleSeriesFilterExpression queryValueFilter,
        ...
        for (; rowGroupIndex < rowGroupReaderList.size(); rowGroupIndex++) {
            ...
            if (rowGroupReader.getValueReaders().containsKey(measurementId) &&
                ...
                res = queryOneSeries(rowGroupReader.getValueReaders().get(measurementId), mergeTimeFilter, queryValueFilter, res, fetchSize);
    ...
    public DynamicOneColumnData queryUsingTimestamps(long[] commonTimestamps) throws IOException {
        ...
        SingleValueVisitor singleValueVisitor = overflowTimeFilter == null ? null : new SingleValueVisitor(overflowTimeFilter);
        ...
        for (long commonTime : commonTimestamps) {
            ...
            if (oldDataIdx < originalQueryData.timeLength && originalQueryData.getTime(oldDataIdx) == commonTime) {
                ...
                if (overflowTimeFilter == null || singleValueVisitor.verify(commonTime)) {
    ...
    private DynamicOneColumnData queryOneSeries(ValueReader valueReader, SingleSeriesFilterExpression timeFilter,
        ...
        while ((res.pageOffset - valueReader.fileOffset) < valueReader.totalSize && resCount < fetchSize) {
            ...
            while (overflowUpdateOperation.hasNext() && overflowUpdateOperation.getUpdateEndTime() < pageMinTime) {
                overflowUpdateOperation.next();
            }
            ...
            if (valueFilter != null && !valueDigestVisitor.satisfy(pageValueDigest, valueFilter)) {
                if ((!overflowUpdateOperation.hasNext() || overflowUpdateOperation.getUpdateStartTime() > pageMaxTime) &&
                    ...
                    for (; timeIdx < pageTimestamps.length; timeIdx++) {
                        ...
                        if ((timeFilter == null || singleTimeVisitor.verify(pageTimestamps[timeIdx])) &&
                            ...
                            if (overflowUpdateOperation.verifyTime(pageTimestamps[timeIdx])) {
                                res.putInt(overflowUpdateOperation.getInt());
                            } else {
                ...
                case BOOLEAN:
                    ...
                    for (; timeIdx < pageTimestamps.length; timeIdx++) {
                        ...
                        if ((timeFilter == null || singleTimeVisitor.verify(pageTimestamps[timeIdx])) &&
                            ...
                            res.putTime(pageTimestamps[timeIdx]);
                            if (overflowUpdateOperation.verifyTime(pageTimestamps[timeIdx])) {
                                res.putBoolean(overflowUpdateOperation.getBoolean());
                            } else {
                ...
                case INT64:
                    ...
                    for (; timeIdx < pageTimestamps.length; timeIdx++) {
                        ...
                        if ((timeFilter == null || singleTimeVisitor.verify(pageTimestamps[timeIdx])) &&
                            ...
                            res.putTime(pageTimestamps[timeIdx]);
                            if (overflowUpdateOperation.verifyTime(pageTimestamps[timeIdx])) {
                                res.putLong(overflowUpdateOperation.getLong());
                            } else {
                ...
                case FLOAT:
                    ...
                    for (; timeIdx < pageTimestamps.length; timeIdx++) {
                        ...
                        if ((timeFilter == null || singleTimeVisitor.verify(pageTimestamps[timeIdx])) &&
                            ...
                            res.putTime(pageTimestamps[timeIdx]);
                            if (overflowUpdateOperation.verifyTime(pageTimestamps[timeIdx])) {
                                res.putFloat(overflowUpdateOperation.getFloat());
                            } else {
                ...
                case DOUBLE:
                    ...
                    for (; timeIdx < pageTimestamps.length; timeIdx++) {
                        ...
                        if ((timeFilter == null || singleTimeVisitor.verify(pageTimestamps[timeIdx])) &&
                            ...
                            res.putTime(pageTimestamps[timeIdx]);
                            if (overflowUpdateOperation.verifyTime(pageTimestamps[timeIdx])) {
                                res.putDouble(overflowUpdateOperation.getDouble());
                            } else {
                ...
                case TEXT:
                    ...
                    for (; timeIdx < pageTimestamps.length; timeIdx++) {
                        ...
                        if ((timeFilter == null || singleTimeVisitor.verify(pageTimestamps[timeIdx])) &&
                            ...
                            res.putTime(pageTimestamps[timeIdx]);
                            if (overflowUpdateOperation.verifyTime(pageTimestamps[timeIdx])) {
                                res.putBinary(overflowUpdateOperation.getText());
                            } else {
