...
public class AuthDao {
	 ...
	 * 			throw exception if at least one of them is incorrect
	 ...
	 * @param username
	 * @return true if the user is deleted, throw exception if the user does not exist
	 * @throws AuthException 
	 */
	 ...
	 * @param roleName
	 * @return true if the role is deleted, throw exception if the role does not exist
	 * @throws AuthException 
	 */
	 ...
	 * 			throw exception if the role already exists 
	 ...
	 * @param path
	 * @param roleName
	 * @return true if success, throw exception the user does not have <roleName> on <path>
	 * @throws PathErrorException 
	 * @throws AuthException 
	 */
	 ...
	 * 			throw exception if the permission is already given to the role
	 * @throws AuthException 
	 */
	public boolean grantRolePermission(String roleName, long permission) throws AuthException {
		...
		if(!success) {
			throw new AuthException("role " + roleName + " already has permission " + Permission.longToName(permission));
		}
		return success;
	}
	 ...
	 * 			throw exception if the permission does not belong to the role
	 * @throws AuthException 
	 */
	public boolean revokeRolePermission(String roleName, long permission) throws AuthException {
		...
		if(!success) {
			throw new AuthException("role " + roleName + " does not have permission " + Permission.longToName(permission));
		}
		return success;
	}
