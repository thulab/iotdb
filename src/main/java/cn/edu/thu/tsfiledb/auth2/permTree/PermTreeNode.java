...
public class PermTreeNode {
	...
	/** collect the roles in the header, if this node is a role-extension
	 *  also collect the roles in the content
	 * @return
	 */
	...
	/** delete a given role by ID within this node, the method is to set the roleID in the entry to -1
	 * @param roleID
	 ...
	 * @param roleID
	 * @return true if the role is added, false when the node is full
	 * 			depending on node manager to issue another attempt
