...
@Generated(value = "Autogenerated by Thrift Compiler (0.9.2)", date = "2017-8-5")
public class TSFetchMetadataResp implements org.apache.thrift.TBase<TSFetchMetadataResp, TSFetchMetadataResp._Fields>, java.io.Serializable, Cloneable, Comparable<TSFetchMetadataResp> {
  ...
  private static final org.apache.thrift.protocol.TField IS_INDEX_EXISTED_FIELD_DESC = new org.apache.thrift.protocol.TField("isIndexExisted", org.apache.thrift.protocol.TType.BOOL, (short)6);
  ...
  public boolean isIndexExisted; // optional
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    IS_INDEX_EXISTED((short)6, "isIndexExisted");
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 5: // ALL_COLUMNS
          return ALL_COLUMNS;
        case 6: // IS_INDEX_EXISTED
          return IS_INDEX_EXISTED;
        default:
          return null;
      }
    }
  ...
  private static final int __ISINDEXEXISTED_ISSET_ID = 0;
  private byte __isset_bitfield = 0;
  private static final _Fields optionals[] = {_Fields.METADATA_IN_JSON,_Fields.DELTA_OBJECT_MAP,_Fields.DATA_TYPE,_Fields.ALL_COLUMNS,_Fields.IS_INDEX_EXISTED};
  ...
  static {
    ...
    tmpMap.put(_Fields.ALL_COLUMNS, new org.apache.thrift.meta_data.FieldMetaData("allColumns", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING))));
    tmpMap.put(_Fields.IS_INDEX_EXISTED, new org.apache.thrift.meta_data.FieldMetaData("isIndexExisted", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
  ...
  public TSFetchMetadataResp(TSFetchMetadataResp other) {
    ...
    this.isIndexExisted = other.isIndexExisted;
  }
  ...
  public void clear() {
    ...
    setIsIndexExistedIsSet(false);
    this.isIndexExisted = false;
  }
  ...
  public boolean isIsIndexExisted() {
    return this.isIndexExisted;
  }

  public TSFetchMetadataResp setIsIndexExisted(boolean isIndexExisted) {
    this.isIndexExisted = isIndexExisted;
    setIsIndexExistedIsSet(true);
    return this;
  }

  public void unsetIsIndexExisted() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __ISINDEXEXISTED_ISSET_ID);
  }

  /** Returns true if field isIndexExisted is set (has been assigned a value) and false otherwise */
  public boolean isSetIsIndexExisted() {
    return EncodingUtils.testBit(__isset_bitfield, __ISINDEXEXISTED_ISSET_ID);
  }

  public void setIsIndexExistedIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __ISINDEXEXISTED_ISSET_ID, value);
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case IS_INDEX_EXISTED:
      if (value == null) {
        unsetIsIndexExisted();
      } else {
        setIsIndexExisted((Boolean)value);
      }
      break;
  ...
  public Object getFieldValue(_Fields field) {
    ...
    case IS_INDEX_EXISTED:
      return Boolean.valueOf(isIsIndexExisted());
  ...
  public boolean equals(TSFetchMetadataResp that) {
    ...
    boolean this_present_isIndexExisted = true && this.isSetIsIndexExisted();
    boolean that_present_isIndexExisted = true && that.isSetIsIndexExisted();
    if (this_present_isIndexExisted || that_present_isIndexExisted) {
      if (!(this_present_isIndexExisted && that_present_isIndexExisted))
        return false;
      if (this.isIndexExisted != that.isIndexExisted)
        return false;
    }
  ...
  public int hashCode() {
    ...
    boolean present_isIndexExisted = true && (isSetIsIndexExisted());
    list.add(present_isIndexExisted);
    if (present_isIndexExisted)
      list.add(isIndexExisted);
  ...
  public int compareTo(TSFetchMetadataResp other) {
    ...
    lastComparison = Boolean.valueOf(isSetIsIndexExisted()).compareTo(other.isSetIsIndexExisted());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetIsIndexExisted()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.isIndexExisted, other.isIndexExisted);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    ...
    if (isSetIsIndexExisted()) {
      if (!first) sb.append(", ");
      sb.append("isIndexExisted:");
      sb.append(this.isIndexExisted);
      first = false;
    }
    sb.append(")");
    return sb.toString();
  ...
  private static class TSFetchMetadataRespStandardScheme extends StandardScheme<TSFetchMetadataResp> {
        ...
        switch (schemeField.id) {
          ...
          case 6: // IS_INDEX_EXISTED
            if (schemeField.type == org.apache.thrift.protocol.TType.BOOL) {
              struct.isIndexExisted = iprot.readBool();
              struct.setIsIndexExistedIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TSFetchMetadataResp struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetIsIndexExisted()) {
        oprot.writeFieldBegin(IS_INDEX_EXISTED_FIELD_DESC);
        oprot.writeBool(struct.isIndexExisted);
        oprot.writeFieldEnd();
      }
