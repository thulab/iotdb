 ...
 * close<br>
 * emptyIntervalFileNode and newFileNodes will changed and stored by overflow
 * flush and overflow close<br>
 * fileNodeProcessorState will changed and stored by work->merge merge->wait
 * wait->work<br>
