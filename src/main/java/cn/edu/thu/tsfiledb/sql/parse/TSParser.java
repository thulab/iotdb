// $ANTLR 3.5.2 TSParser.g 2017-07-26 15:07:52
...
public class TSParser extends Parser {
	...
	public final TSParser.dropIndexStatement_return dropIndexStatement() throws RecognitionException {
		...
		try {
			...
			pushFollow(FOLLOW_timeseries_in_dropIndexStatement2470);
			p=timeseries();
			state._fsp--;
			if (state.failed) return retval;
			if ( state.backtracking==0 ) stream_timeseries.add(p.getTree());
	...
	// TSParser.g:614:1: selectClause : ( KW_SELECT KW_INDEX func= Identifier LPAREN p1= timeseries COMMA p2= timeseries COMMA n1= dateFormatWithNumber COMMA n2= dateFormatWithNumber COMMA epsilon= Float ( COMMA alpha= Float COMMA beta= Float )? RPAREN -> ^( TOK_SELECT_INDEX $func $p1 $p2 $n1 $n2 $epsilon ( $alpha $beta)? ) | KW_SELECT clusteredPath ( COMMA clusteredPath )* -> ^( TOK_SELECT ( clusteredPath )+ ) );
	public final TSParser.selectClause_return selectClause() throws RecognitionException {
		...
		ParserRuleReturnScope clusteredPath210 =null;
		...
		CommonTree KW_SELECT207_tree=null;
		...
		try {
			// TSParser.g:615:5: ( KW_SELECT KW_INDEX func= Identifier LPAREN p1= timeseries COMMA p2= timeseries COMMA n1= dateFormatWithNumber COMMA n2= dateFormatWithNumber COMMA epsilon= Float ( COMMA alpha= Float COMMA beta= Float )? RPAREN -> ^( TOK_SELECT_INDEX $func $p1 $p2 $n1 $n2 $epsilon ( $alpha $beta)? ) | KW_SELECT clusteredPath ( COMMA clusteredPath )* -> ^( TOK_SELECT ( clusteredPath )+ ) )
			int alt31=2;
			...
			switch (alt31) {
				case 1 :
					// TSParser.g:615:7: KW_SELECT KW_INDEX func= Identifier LPAREN p1= timeseries COMMA p2= timeseries COMMA n1= dateFormatWithNumber COMMA n2= dateFormatWithNumber COMMA epsilon= Float ( COMMA alpha= Float COMMA beta= Float )? RPAREN
					{
					...
					pushFollow(FOLLOW_timeseries_in_selectClause2552);
					p1=timeseries();
					state._fsp--;
					if (state.failed) return retval;
					if ( state.backtracking==0 ) stream_timeseries.add(p1.getTree());
					...
					pushFollow(FOLLOW_timeseries_in_selectClause2558);
					p2=timeseries();
					state._fsp--;
					if (state.failed) return retval;
					if ( state.backtracking==0 ) stream_timeseries.add(p2.getTree());
					...
					pushFollow(FOLLOW_dateFormatWithNumber_in_selectClause2564);
					n1=dateFormatWithNumber();
					state._fsp--;
					if (state.failed) return retval;
					if ( state.backtracking==0 ) stream_dateFormatWithNumber.add(n1.getTree());
					COMMA202=(Token)match(input,COMMA,FOLLOW_COMMA_in_selectClause2566); if (state.failed) return retval; 
					if ( state.backtracking==0 ) stream_COMMA.add(COMMA202);

					pushFollow(FOLLOW_dateFormatWithNumber_in_selectClause2570);
					n2=dateFormatWithNumber();
					state._fsp--;
					if (state.failed) return retval;
					if ( state.backtracking==0 ) stream_dateFormatWithNumber.add(n2.getTree());
					COMMA203=(Token)match(input,COMMA,FOLLOW_COMMA_in_selectClause2572); if (state.failed) return retval; 
					if ( state.backtracking==0 ) stream_COMMA.add(COMMA203);

					epsilon=(Token)match(input,Float,FOLLOW_Float_in_selectClause2576); if (state.failed) return retval; 
					if ( state.backtracking==0 ) stream_Float.add(epsilon);

					// TSParser.g:615:163: ( COMMA alpha= Float COMMA beta= Float )?
					int alt29=2;
					...
					switch (alt29) {
						case 1 :
							// TSParser.g:615:164: COMMA alpha= Float COMMA beta= Float
							{
							COMMA204=(Token)match(input,COMMA,FOLLOW_COMMA_in_selectClause2579); if (state.failed) return retval; 
							if ( state.backtracking==0 ) stream_COMMA.add(COMMA204);

							alpha=(Token)match(input,Float,FOLLOW_Float_in_selectClause2583); if (state.failed) return retval; 
							if ( state.backtracking==0 ) stream_Float.add(alpha);

							COMMA205=(Token)match(input,COMMA,FOLLOW_COMMA_in_selectClause2585); if (state.failed) return retval; 
							if ( state.backtracking==0 ) stream_COMMA.add(COMMA205);

							beta=(Token)match(input,Float,FOLLOW_Float_in_selectClause2589); if (state.failed) return retval; 
					...
					RPAREN206=(Token)match(input,RPAREN,FOLLOW_RPAREN_in_selectClause2593); if (state.failed) return retval; 
					if ( state.backtracking==0 ) stream_RPAREN.add(RPAREN206);

					// AST REWRITE
					// elements: alpha, p2, n2, epsilon, func, n1, beta, p1
					// token labels: epsilon, func, alpha, beta
					// rule labels: p1, p2, n1, n2, retval
					// token list labels: 
					// rule list labels: 
					// wildcard labels: 
					if ( state.backtracking==0 ) {
					...
					root_0 = (CommonTree)adaptor.nil();
					// 616:5: -> ^( TOK_SELECT_INDEX $func $p1 $p2 $n1 $n2 $epsilon ( $alpha $beta)? )
					{
						// TSParser.g:616:8: ^( TOK_SELECT_INDEX $func $p1 $p2 $n1 $n2 $epsilon ( $alpha $beta)? )
						{
						CommonTree root_1 = (CommonTree)adaptor.nil();
				...
				case 2 :
					...
					{
					KW_SELECT207=(Token)match(input,KW_SELECT,FOLLOW_KW_SELECT_in_selectClause2638); if (state.failed) return retval; 
					if ( state.backtracking==0 ) stream_KW_SELECT.add(KW_SELECT207);

					pushFollow(FOLLOW_clusteredPath_in_selectClause2640);
					...
					while (true) {
						...
						case 1 :
							...
							{
							COMMA209=(Token)match(input,COMMA,FOLLOW_COMMA_in_selectClause2643); if (state.failed) return retval; 
							if ( state.backtracking==0 ) stream_COMMA.add(COMMA209);

							pushFollow(FOLLOW_clusteredPath_in_selectClause2645);
							clusteredPath210=clusteredPath();
							state._fsp--;
							if (state.failed) return retval;
							if ( state.backtracking==0 ) stream_clusteredPath.add(clusteredPath210.getTree());
							}
							break;
		...
		try {
			...
			switch (alt32) {
				case 1 :
					...
					{
					pushFollow(FOLLOW_identifier_in_clusteredPath2678);
					clstcmd=identifier();
					state._fsp--;
					if (state.failed) return retval;
					if ( state.backtracking==0 ) stream_identifier.add(clstcmd.getTree());
					LPAREN211=(Token)match(input,LPAREN,FOLLOW_LPAREN_in_clusteredPath2680); if (state.failed) return retval; 
					if ( state.backtracking==0 ) stream_LPAREN.add(LPAREN211);

					pushFollow(FOLLOW_path_in_clusteredPath2682);
					path212=path();
					state._fsp--;
					if (state.failed) return retval;
					if ( state.backtracking==0 ) stream_path.add(path212.getTree());
					RPAREN213=(Token)match(input,RPAREN,FOLLOW_RPAREN_in_clusteredPath2684); if (state.failed) return retval; 
				...
				case 2 :
					...
					{
					pushFollow(FOLLOW_path_in_clusteredPath2706);
					path214=path();
					state._fsp--;
					if (state.failed) return retval;
	...
	public final TSParser.fromClause_return fromClause() throws RecognitionException {
		...
		CommonTree KW_FROM215_tree=null;
		...
		try {
			...
			{
			KW_FROM215=(Token)match(input,KW_FROM,FOLLOW_KW_FROM_in_fromClause2729); if (state.failed) return retval; 
			if ( state.backtracking==0 ) stream_KW_FROM.add(KW_FROM215);

			pushFollow(FOLLOW_path_in_fromClause2731);
			path216=path();
			state._fsp--;
			if (state.failed) return retval;
			...
			while (true) {
				...
				case 1 :
					...
					{
					COMMA217=(Token)match(input,COMMA,FOLLOW_COMMA_in_fromClause2734); if (state.failed) return retval; 
					if ( state.backtracking==0 ) stream_COMMA.add(COMMA217);

					pushFollow(FOLLOW_path_in_fromClause2736);
					path218=path();
					state._fsp--;
					if (state.failed) return retval;
					if ( state.backtracking==0 ) stream_path.add(path218.getTree());
					}
					break;
	...
	public final TSParser.whereClause_return whereClause() throws RecognitionException {
		...
		Token KW_WHERE219=null;
		ParserRuleReturnScope searchCondition220 =null;

		CommonTree KW_WHERE219_tree=null;
		...
		try {
			...
			{
			KW_WHERE219=(Token)match(input,KW_WHERE,FOLLOW_KW_WHERE_in_whereClause2769); if (state.failed) return retval; 
			if ( state.backtracking==0 ) stream_KW_WHERE.add(KW_WHERE219);

			pushFollow(FOLLOW_searchCondition_in_whereClause2771);
			searchCondition220=searchCondition();
			state._fsp--;
			if (state.failed) return retval;
			if ( state.backtracking==0 ) stream_searchCondition.add(searchCondition220.getTree());
			// AST REWRITE
	...
	public final TSParser.searchCondition_return searchCondition() throws RecognitionException {
		...
		try {
			...
			pushFollow(FOLLOW_expression_in_searchCondition2800);
	...
	public final TSParser.expression_return expression() throws RecognitionException {
		...
		ParserRuleReturnScope precedenceOrExpression222 =null;
		...
		try {
			...
			pushFollow(FOLLOW_precedenceOrExpression_in_expression2821);
			precedenceOrExpression222=precedenceOrExpression();
			state._fsp--;
			if (state.failed) return retval;
			if ( state.backtracking==0 ) adaptor.addChild(root_0, precedenceOrExpression222.getTree());
	...
	public final TSParser.precedenceOrExpression_return precedenceOrExpression() throws RecognitionException {
		...
		try {
			...
			pushFollow(FOLLOW_precedenceAndExpression_in_precedenceOrExpression2842);
			...
			while (true) {
				...
				case 1 :
					...
					{
					KW_OR224=(Token)match(input,KW_OR,FOLLOW_KW_OR_in_precedenceOrExpression2846); if (state.failed) return retval;
					if ( state.backtracking==0 ) {
					KW_OR224_tree = (CommonTree)adaptor.create(KW_OR224);
					root_0 = (CommonTree)adaptor.becomeRoot(KW_OR224_tree, root_0);
					}

					pushFollow(FOLLOW_precedenceAndExpression_in_precedenceOrExpression2849);
	...
	public final TSParser.precedenceAndExpression_return precedenceAndExpression() throws RecognitionException {
		...
		Token KW_AND227=null;
		ParserRuleReturnScope precedenceNotExpression226 =null;
		ParserRuleReturnScope precedenceNotExpression228 =null;

		CommonTree KW_AND227_tree=null;
		...
		try {
			...
			pushFollow(FOLLOW_precedenceNotExpression_in_precedenceAndExpression2872);
			...
			while (true) {
				...
				case 1 :
					...
					{
					KW_AND227=(Token)match(input,KW_AND,FOLLOW_KW_AND_in_precedenceAndExpression2876); if (state.failed) return retval;
					if ( state.backtracking==0 ) {
					KW_AND227_tree = (CommonTree)adaptor.create(KW_AND227);
					root_0 = (CommonTree)adaptor.becomeRoot(KW_AND227_tree, root_0);
					}

					pushFollow(FOLLOW_precedenceNotExpression_in_precedenceAndExpression2879);
					precedenceNotExpression228=precedenceNotExpression();
					state._fsp--;
					if (state.failed) return retval;
					if ( state.backtracking==0 ) adaptor.addChild(root_0, precedenceNotExpression228.getTree());
	...
	public final TSParser.precedenceNotExpression_return precedenceNotExpression() throws RecognitionException {
		...
		ParserRuleReturnScope precedenceEqualExpressionSingle230 =null;
		...
		try {
			...
			while (true) {
				...
				case 1 :
					...
					{
					KW_NOT229=(Token)match(input,KW_NOT,FOLLOW_KW_NOT_in_precedenceNotExpression2903); if (state.failed) return retval;
					if ( state.backtracking==0 ) {
					KW_NOT229_tree = (CommonTree)adaptor.create(KW_NOT229);
					root_0 = (CommonTree)adaptor.becomeRoot(KW_NOT229_tree, root_0);
					}
			...
			pushFollow(FOLLOW_precedenceEqualExpressionSingle_in_precedenceNotExpression2908);
			precedenceEqualExpressionSingle230=precedenceEqualExpressionSingle();
			state._fsp--;
			if (state.failed) return retval;
			if ( state.backtracking==0 ) adaptor.addChild(root_0, precedenceEqualExpressionSingle230.getTree());
	...
	public final TSParser.precedenceEqualExpressionSingle_return precedenceEqualExpressionSingle() throws RecognitionException {
		...
		ParserRuleReturnScope precedenceEqualOperator231 =null;
		...
		try {
			...
			{
			pushFollow(FOLLOW_atomExpression_in_precedenceEqualExpressionSingle2933);
			left=atomExpression();
			state._fsp--;
			if (state.failed) return retval;
			...
			while (true) {
				...
				case 1 :
					...
					{
					pushFollow(FOLLOW_precedenceEqualOperator_in_precedenceEqualExpressionSingle2953);
					precedenceEqualOperator231=precedenceEqualOperator();
					state._fsp--;
					if (state.failed) return retval;
					if ( state.backtracking==0 ) stream_precedenceEqualOperator.add(precedenceEqualOperator231.getTree());
					pushFollow(FOLLOW_atomExpression_in_precedenceEqualExpressionSingle2957);
		...
		try {
			...
			switch (alt38) {
				case 1 :
					...
					{
					KW_NULL233=(Token)match(input,KW_NULL,FOLLOW_KW_NULL_in_nullCondition3053); if (state.failed) return retval; 
				...
				case 2 :
					...
					{
					KW_NOT234=(Token)match(input,KW_NOT,FOLLOW_KW_NOT_in_nullCondition3067); if (state.failed) return retval; 
					if ( state.backtracking==0 ) stream_KW_NOT.add(KW_NOT234);

					KW_NULL235=(Token)match(input,KW_NULL,FOLLOW_KW_NULL_in_nullCondition3069); if (state.failed) return retval; 
					if ( state.backtracking==0 ) stream_KW_NULL.add(KW_NULL235);
	...
	public final TSParser.atomExpression_return atomExpression() throws RecognitionException {
		...
		Token KW_NULL236=null;
		Token LPAREN239=null;
		Token RPAREN241=null;
		ParserRuleReturnScope constant237 =null;
		ParserRuleReturnScope path238 =null;
		ParserRuleReturnScope expression240 =null;

		CommonTree KW_NULL236_tree=null;
		...
		try {
			...
			switch (alt39) {
				case 1 :
					...
					{
					KW_NULL236=(Token)match(input,KW_NULL,FOLLOW_KW_NULL_in_atomExpression3104); if (state.failed) return retval; 
					if ( state.backtracking==0 ) stream_KW_NULL.add(KW_NULL236);
				...
				case 2 :
					...
					pushFollow(FOLLOW_constant_in_atomExpression3122);
					constant237=constant();
					state._fsp--;
					if (state.failed) return retval;
					if ( state.backtracking==0 ) adaptor.addChild(root_0, constant237.getTree());
				...
				case 3 :
					...
					pushFollow(FOLLOW_path_in_atomExpression3130);
					path238=path();
					state._fsp--;
					if (state.failed) return retval;
					if ( state.backtracking==0 ) adaptor.addChild(root_0, path238.getTree());
				...
				case 4 :
					...
					LPAREN239=(Token)match(input,LPAREN,FOLLOW_LPAREN_in_atomExpression3138); if (state.failed) return retval;
					pushFollow(FOLLOW_expression_in_atomExpression3141);
					expression240=expression();
					state._fsp--;
					if (state.failed) return retval;
					if ( state.backtracking==0 ) adaptor.addChild(root_0, expression240.getTree());

					RPAREN241=(Token)match(input,RPAREN,FOLLOW_RPAREN_in_atomExpression3143); if (state.failed) return retval;
					}
					break;
	...
	public final TSParser.constant_return constant() throws RecognitionException {
		...
		Token StringLiteral243=null;
		ParserRuleReturnScope number242 =null;
		ParserRuleReturnScope dateFormat244 =null;

		CommonTree StringLiteral243_tree=null;
		...
		try {
			...
			switch (alt40) {
				case 1 :
					...
					pushFollow(FOLLOW_number_in_constant3161);
					number242=number();
					state._fsp--;
					if (state.failed) return retval;
				...
				case 2 :
					...
					StringLiteral243=(Token)match(input,StringLiteral,FOLLOW_StringLiteral_in_constant3169); if (state.failed) return retval;
					if ( state.backtracking==0 ) {
					StringLiteral243_tree = (CommonTree)adaptor.create(StringLiteral243);
					adaptor.addChild(root_0, StringLiteral243_tree);
					}
				...
				case 3 :
					...
					pushFollow(FOLLOW_dateFormat_in_constant3177);
					dateFormat244=dateFormat();
					state._fsp--;
					if (state.failed) return retval;
					if ( state.backtracking==0 ) adaptor.addChild(root_0, dateFormat244.getTree());
	...
	public final void synpred1_TSParser_fragment() throws RecognitionException {
		...
		{
		match(input,KW_NULL,FOLLOW_KW_NULL_in_synpred1_TSParser3099); if (state.failed) return;
	...
	public final void synpred2_TSParser_fragment() throws RecognitionException {
		...
		{
		pushFollow(FOLLOW_constant_in_synpred2_TSParser3117);
		constant();
		state._fsp--;
	...
	public static final BitSet FOLLOW_KW_ON_in_dropIndexStatement2466 = new BitSet(new long[]{0x0000000000010000L});
	public static final BitSet FOLLOW_timeseries_in_dropIndexStatement2470 = new BitSet(new long[]{0x0000000000000002L});
	...
	public static final BitSet FOLLOW_LPAREN_in_selectClause2548 = new BitSet(new long[]{0x0000000000010000L});
	public static final BitSet FOLLOW_timeseries_in_selectClause2552 = new BitSet(new long[]{0x0000000000000020L});
	public static final BitSet FOLLOW_COMMA_in_selectClause2554 = new BitSet(new long[]{0x0000000000010000L});
	public static final BitSet FOLLOW_timeseries_in_selectClause2558 = new BitSet(new long[]{0x0000000000000020L});
	public static final BitSet FOLLOW_COMMA_in_selectClause2560 = new BitSet(new long[]{0x0000000000030040L});
	public static final BitSet FOLLOW_dateFormatWithNumber_in_selectClause2564 = new BitSet(new long[]{0x0000000000000020L});
	public static final BitSet FOLLOW_COMMA_in_selectClause2566 = new BitSet(new long[]{0x0000000000030040L});
	public static final BitSet FOLLOW_dateFormatWithNumber_in_selectClause2570 = new BitSet(new long[]{0x0000000000000020L});
	public static final BitSet FOLLOW_COMMA_in_selectClause2572 = new BitSet(new long[]{0x0000000000001000L});
	public static final BitSet FOLLOW_Float_in_selectClause2576 = new BitSet(new long[]{0x0000000000000020L,0x0000000000000100L});
	public static final BitSet FOLLOW_COMMA_in_selectClause2579 = new BitSet(new long[]{0x0000000000001000L});
	public static final BitSet FOLLOW_Float_in_selectClause2583 = new BitSet(new long[]{0x0000000000000020L});
	public static final BitSet FOLLOW_COMMA_in_selectClause2585 = new BitSet(new long[]{0x0000000000001000L});
	public static final BitSet FOLLOW_Float_in_selectClause2589 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000100L});
	public static final BitSet FOLLOW_RPAREN_in_selectClause2593 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_KW_SELECT_in_selectClause2638 = new BitSet(new long[]{0x0000000000030000L,0x0000000000000400L});
	public static final BitSet FOLLOW_clusteredPath_in_selectClause2640 = new BitSet(new long[]{0x0000000000000022L});
	public static final BitSet FOLLOW_COMMA_in_selectClause2643 = new BitSet(new long[]{0x0000000000030000L,0x0000000000000400L});
	public static final BitSet FOLLOW_clusteredPath_in_selectClause2645 = new BitSet(new long[]{0x0000000000000022L});
	public static final BitSet FOLLOW_identifier_in_clusteredPath2678 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000004L});
	public static final BitSet FOLLOW_LPAREN_in_clusteredPath2680 = new BitSet(new long[]{0x0000000000030000L,0x0000000000000400L});
	public static final BitSet FOLLOW_path_in_clusteredPath2682 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000100L});
	public static final BitSet FOLLOW_RPAREN_in_clusteredPath2684 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_path_in_clusteredPath2706 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_KW_FROM_in_fromClause2729 = new BitSet(new long[]{0x0000000000030000L,0x0000000000000400L});
	public static final BitSet FOLLOW_path_in_fromClause2731 = new BitSet(new long[]{0x0000000000000022L});
	public static final BitSet FOLLOW_COMMA_in_fromClause2734 = new BitSet(new long[]{0x0000000000030000L,0x0000000000000400L});
	public static final BitSet FOLLOW_path_in_fromClause2736 = new BitSet(new long[]{0x0000000000000022L});
	public static final BitSet FOLLOW_KW_WHERE_in_whereClause2769 = new BitSet(new long[]{0x000000C000031040L,0x0000000000000C04L});
	public static final BitSet FOLLOW_searchCondition_in_whereClause2771 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_expression_in_searchCondition2800 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_precedenceOrExpression_in_expression2821 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_precedenceAndExpression_in_precedenceOrExpression2842 = new BitSet(new long[]{0x0000020000000002L});
	public static final BitSet FOLLOW_KW_OR_in_precedenceOrExpression2846 = new BitSet(new long[]{0x000000C000031040L,0x0000000000000C04L});
	public static final BitSet FOLLOW_precedenceAndExpression_in_precedenceOrExpression2849 = new BitSet(new long[]{0x0000020000000002L});
	public static final BitSet FOLLOW_precedenceNotExpression_in_precedenceAndExpression2872 = new BitSet(new long[]{0x0000000000080002L});
	public static final BitSet FOLLOW_KW_AND_in_precedenceAndExpression2876 = new BitSet(new long[]{0x000000C000031040L,0x0000000000000C04L});
	public static final BitSet FOLLOW_precedenceNotExpression_in_precedenceAndExpression2879 = new BitSet(new long[]{0x0000000000080002L});
	public static final BitSet FOLLOW_KW_NOT_in_precedenceNotExpression2903 = new BitSet(new long[]{0x000000C000031040L,0x0000000000000C04L});
	public static final BitSet FOLLOW_precedenceEqualExpressionSingle_in_precedenceNotExpression2908 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_atomExpression_in_precedenceEqualExpressionSingle2933 = new BitSet(new long[]{0x0000000000006C02L,0x0000000000000023L});
	public static final BitSet FOLLOW_precedenceEqualOperator_in_precedenceEqualExpressionSingle2953 = new BitSet(new long[]{0x0000008000031040L,0x0000000000000C04L});
	public static final BitSet FOLLOW_atomExpression_in_precedenceEqualExpressionSingle2957 = new BitSet(new long[]{0x0000000000006C02L,0x0000000000000023L});
	public static final BitSet FOLLOW_KW_NULL_in_nullCondition3053 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_KW_NOT_in_nullCondition3067 = new BitSet(new long[]{0x0000008000000000L});
	public static final BitSet FOLLOW_KW_NULL_in_nullCondition3069 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_KW_NULL_in_atomExpression3104 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_constant_in_atomExpression3122 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_path_in_atomExpression3130 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_LPAREN_in_atomExpression3138 = new BitSet(new long[]{0x000000C000031040L,0x0000000000000C04L});
	public static final BitSet FOLLOW_expression_in_atomExpression3141 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000100L});
	public static final BitSet FOLLOW_RPAREN_in_atomExpression3143 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_number_in_constant3161 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_StringLiteral_in_constant3169 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_dateFormat_in_constant3177 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_KW_NULL_in_synpred1_TSParser3099 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_constant_in_synpred2_TSParser3117 = new BitSet(new long[]{0x0000000000000002L});
}
