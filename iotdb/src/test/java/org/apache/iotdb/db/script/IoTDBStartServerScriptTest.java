...
public class IoTDBStartServerScriptTest {
    ...
    private void testStartClientOnWindows(String suffix, String os) throws IOException {
        ...
        String startCMD = dir + File.separator + "iotdb" + File.separator + "bin" + File.separator + "start-server"
                + suffix;
        ProcessBuilder startBuilder = new ProcessBuilder("cmd.exe", "/c", startCMD);
        String stopCMD = dir + File.separator + "iotdb" + File.separator + "bin" + File.separator + "stop-server"
                + suffix;
    ...
    private void testOutput(String dir, String suffix, ProcessBuilder startBuilder, ProcessBuilder stopBuilder,
