...
public class BufferWriteProcessor extends Processor {
    ...
    public void close() throws BufferWriteProcessorException {
        try {
            ...
            ZonedDateTime endDateTime = ZonedDateTime.ofInstant(Instant.ofEpochMilli(closeEndTime), ZoneId.of(TsfileDBDescriptor.getInstance().getConfig().offset.toString()));
            LOGGER.info(
