...
public class EngineDataSetWithTimeGenerator extends QueryDataSet {
    ...
    public EngineDataSetWithTimeGenerator(List<Path> paths, List<TSDataType> dataTypes, EngineTimeGenerator timeGenerator, List<EngineReaderByTimeStamp> readers) {
