...
public class TSDynamicOneColumnData implements org.apache.thrift.TBase<TSDynamicOneColumnData, TSDynamicOneColumnData._Fields>, java.io.Serializable, Cloneable, Comparable<TSDynamicOneColumnData> {
  ...
  private static final _Fields optionals[] = {_Fields.BOOL_LIST,_Fields.I32_LIST,_Fields.I64_LIST,_Fields.FLOAT_LIST,_Fields.DOUBLE_LIST,_Fields.BINARY_LIST,_Fields.EMPTY_LIST};
  ...
  public int hashCode() {
    ...
    boolean present_emptyList = true && (isSetEmptyList());
    list.add(present_emptyList);
    if (present_emptyList)
      list.add(emptyList);
      ...
      if (incoming.get(4)) {
        {
          ...
          for (int _i109 = 0; _i109 < _list107.size; ++_i109)
          {
            ...
            struct.doubleList.add(_elem108);
          }
        }
        struct.setDoubleListIsSet(true);
      }
      if (incoming.get(5)) {
        {
          ...
          for (int _i112 = 0; _i112 < _list110.size; ++_i112)
          {
            ...
            struct.binaryList.add(_elem111);
          }
        }
        struct.setBinaryListIsSet(true);
      }
