...
public class TSDynamicOneColumnData implements org.apache.thrift.TBase<TSDynamicOneColumnData, TSDynamicOneColumnData._Fields>, java.io.Serializable, Cloneable, Comparable<TSDynamicOneColumnData> {
  ...
  private _Fields optionals[] = {_Fields.BOOL_LIST,_Fields.I32_LIST,_Fields.I64_LIST,_Fields.FLOAT_LIST,_Fields.DOUBLE_LIST,_Fields.BINARY_LIST};
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TSDynamicOneColumnData struct) throws org.apache.thrift.TException {
      ...
      if (struct.timeRet != null) {
        oprot.writeFieldBegin(TIME_RET_FIELD_DESC);
        {
          ...
          for (long _iter73 : struct.timeRet)
          {
      ...
      if (struct.boolList != null) {
        if (struct.isSetBoolList()) {
          oprot.writeFieldBegin(BOOL_LIST_FIELD_DESC);
          {
            ...
            for (boolean _iter74 : struct.boolList)
            {
      ...
      if (struct.i32List != null) {
        if (struct.isSetI32List()) {
          oprot.writeFieldBegin(I32_LIST_FIELD_DESC);
          {
            ...
            for (int _iter75 : struct.i32List)
            {
      ...
      if (struct.i64List != null) {
        if (struct.isSetI64List()) {
          oprot.writeFieldBegin(I64_LIST_FIELD_DESC);
          {
            ...
            for (long _iter76 : struct.i64List)
            {
      ...
      if (struct.floatList != null) {
        if (struct.isSetFloatList()) {
          oprot.writeFieldBegin(FLOAT_LIST_FIELD_DESC);
          {
            ...
            for (double _iter77 : struct.floatList)
            {
      ...
      if (struct.doubleList != null) {
        if (struct.isSetDoubleList()) {
          oprot.writeFieldBegin(DOUBLE_LIST_FIELD_DESC);
          {
            ...
            for (double _iter78 : struct.doubleList)
            {
      ...
      if (struct.binaryList != null) {
        if (struct.isSetBinaryList()) {
          oprot.writeFieldBegin(BINARY_LIST_FIELD_DESC);
          {
            ...
            for (ByteBuffer _iter79 : struct.binaryList)
            {
  ...
  private static class TSDynamicOneColumnDataTupleScheme extends TupleScheme<TSDynamicOneColumnData> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TSDynamicOneColumnData struct) throws org.apache.thrift.TException {
      ...
      oprot.writeI32(struct.length);
      {
        ...
        for (long _iter80 : struct.timeRet)
        {
      ...
      if (struct.isSetBoolList()) {
        {
          ...
          for (boolean _iter81 : struct.boolList)
          {
      ...
      if (struct.isSetI32List()) {
        {
          ...
          for (int _iter82 : struct.i32List)
          {
      ...
      if (struct.isSetI64List()) {
        {
          ...
          for (long _iter83 : struct.i64List)
          {
      ...
      if (struct.isSetFloatList()) {
        {
          ...
          for (double _iter84 : struct.floatList)
          {
      ...
      if (struct.isSetDoubleList()) {
        {
          ...
          for (double _iter85 : struct.doubleList)
          {
      ...
      if (struct.isSetBinaryList()) {
        {
          ...
          for (ByteBuffer _iter86 : struct.binaryList)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TSDynamicOneColumnData struct) throws org.apache.thrift.TException {
      ...
      struct.setLengthIsSet(true);
      {
        ...
        struct.timeRet = new ArrayList<Long>(_list87.size);
        for (int _i88 = 0; _i88 < _list87.size; ++_i88)
        {
          long _elem89;
          _elem89 = iprot.readI64();
          struct.timeRet.add(_elem89);
        }
      }
      struct.setTimeRetIsSet(true);
      ...
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TList _list90 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.BOOL, iprot.readI32());
          struct.boolList = new ArrayList<Boolean>(_list90.size);
          for (int _i91 = 0; _i91 < _list90.size; ++_i91)
          {
            boolean _elem92;
            _elem92 = iprot.readBool();
            struct.boolList.add(_elem92);
          }
        }
        struct.setBoolListIsSet(true);
      }
      if (incoming.get(1)) {
        {
          ...
          struct.i32List = new ArrayList<Integer>(_list93.size);
          for (int _i94 = 0; _i94 < _list93.size; ++_i94)
          {
            int _elem95;
            _elem95 = iprot.readI32();
            struct.i32List.add(_elem95);
          }
        }
        struct.setI32ListIsSet(true);
      }
      if (incoming.get(2)) {
        {
          ...
          struct.i64List = new ArrayList<Long>(_list96.size);
          for (int _i97 = 0; _i97 < _list96.size; ++_i97)
          {
            long _elem98;
            _elem98 = iprot.readI64();
            struct.i64List.add(_elem98);
          }
        }
        struct.setI64ListIsSet(true);
      }
      if (incoming.get(3)) {
        {
          ...
          struct.floatList = new ArrayList<Double>(_list99.size);
          for (int _i100 = 0; _i100 < _list99.size; ++_i100)
          {
            double _elem101;
            _elem101 = iprot.readDouble();
            struct.floatList.add(_elem101);
          }
        }
        struct.setFloatListIsSet(true);
      }
      if (incoming.get(4)) {
        {
          org.apache.thrift.protocol.TList _list102 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.DOUBLE, iprot.readI32());
          struct.doubleList = new ArrayList<Double>(_list102.size);
          for (int _i103 = 0; _i103 < _list102.size; ++_i103)
          {
            double _elem104;
            _elem104 = iprot.readDouble();
            struct.doubleList.add(_elem104);
          }
        }
        struct.setDoubleListIsSet(true);
      }
      if (incoming.get(5)) {
        {
          ...
          struct.binaryList = new ArrayList<ByteBuffer>(_list105.size);
          for (int _i106 = 0; _i106 < _list105.size; ++_i106)
          {
            ByteBuffer _elem107;
            _elem107 = iprot.readBinary();
            struct.binaryList.add(_elem107);
          }
        }
        struct.setBinaryListIsSet(true);
      }
