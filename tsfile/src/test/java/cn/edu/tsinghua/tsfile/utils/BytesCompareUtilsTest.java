...
public class BytesCompareUtilsTest {
  ...
  public void testFloatToBytes() throws Exception {
    ...
    assertEquals("testBytesToFloat", b, bf, Constant.float_min_delta);
  }
  ...
  public void testFloatToBytesWithBytesArray() {
    ...
    assertEquals(b1, rb1, Constant.float_min_delta);
    assertEquals(b2, rb2, Constant.float_min_delta);
  }
  ...
  public void testDoubleToBytesWithBytesArray() {
    ...
    assertEquals(b1, rb1, Constant.double_min_delta);
    assertEquals(b2, rb2, Constant.double_min_delta);
  }
  ...
  public void testConcatByteArray() {
    ...
    assertEquals(f1, rf1, Constant.float_min_delta);
    assertEquals(b1, rb1);
  }
  ...
  public void testReadFloat() throws IOException {
    ...
    InputStream in = new ByteArrayInputStream(bs);
    assertEquals(l, BytesUtils.readFloat(in), Constant.float_min_delta);
  }
  ...
  public void testReadDouble() throws IOException {
    ...
    InputStream in = new ByteArrayInputStream(bs);
    assertEquals(l, BytesUtils.readDouble(in), Constant.double_min_delta);
  }
