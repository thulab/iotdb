...
public class MetadataGenerator {
    ...
    public static TsFileMetaData createSimpleFileMetaData() {
        ...
        metaData.addMeasurementSchema(MetadataGenerator.createSimpleMeasurementSchema());
        metaData.addMeasurementSchema(MetadataGenerator.createSimpleMeasurementSchema());
    ...
    public static TsDeviceMetadata createSimpleDeviceMetaData() {
        ...
        metaData.addChunkGroupMetaData(MetadataGenerator.createSimpleChunkGroupMetaData());
        metaData.addChunkGroupMetaData(MetadataGenerator.createSimpleChunkGroupMetaData());
        return metaData;
    }
    ...
    public static ChunkGroupMetaData createSimpleChunkGroupMetaData() {
        ...
        metaData.addTimeSeriesChunkMetaData(MetadataGenerator.createSimpleTimeSeriesChunkMetaData());
        metaData.addTimeSeriesChunkMetaData(MetadataGenerator.createSimpleTimeSeriesChunkMetaData());
        return metaData;
    }
