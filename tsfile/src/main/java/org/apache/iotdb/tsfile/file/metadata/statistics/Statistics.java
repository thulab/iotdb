...
/**
 * This class is used for recording statistic information of each measurement in a delta file.While writing processing,
 * the processor records the digest information. Statistics includes maximum, minimum and null value count up to version
 * 0.0.1.<br>
...
public abstract class Statistics<T> {
    ...
    public void mergeStatistics(Statistics<?> stats) throws StatisticsClassException {
        ...
        if (this.getClass() == stats.getClass()) {
            ...
            LOG.warn("tsfile-file Statistics classes mismatched,no merge: " + this.getClass().toString() + " vs. "
    ...
    /**
     * This method with two parameters is only used by {@code overflow} which updates/inserts/deletes timestamp.
     *
     * @param min
     *            min timestamp
     * @param max
    ...
    public int getSerializedSize() {
        if (sizeOfDatum() == 0) {
            ...
            return 4 * Integer.BYTES + getMaxBytes().length + getMinBytes().length + getFirstBytes().length
