...
public class ChunkGroupMetaData {
     ...
     *            all time series chunks in this chunk group. Can not be Null. notice: after constructing a
     *            ChunkGroupMetadata instance. Donot use list.add() to modify `chunkMetaDataList`. Instead, use
     *            addTimeSeriesChunkMetaData() to make sure getSerializedSize() is correct.
     */
