...
public class ReadOnlyTsFile {
  ...
  public QueryDataSet query(QueryExpression queryExpression, HashMap<String, Long> parameters)
      throws IOException { //TODO PARTITION
    return tsFileExecutor.execute(queryExpression, parameters);
  }
